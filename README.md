A course learning platform built with a nextjs frontend and node backend, paired with dynamoDB. Makes use of clerk for authetication and stripe for payment processing.
